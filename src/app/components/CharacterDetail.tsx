    ...
    <div className={styles.detailContainer}>
      <div className={styles.leftSection}>
        ...
        <div className={styles.gangSection}>
          ...
          <p>{character.gangAffiliations}</p>
        </div>
        ...
        <div className={styles.statsSection}>
          ...
          <div className={styles.statsGrid}>
            <div className={styles.statItem}>
              ...
              <span className={styles.statValue}>{character.stats.reputation}</span>
            </div>
            <div className={styles.statItem}>
              <span className={styles.statLabel}>Street Cred</span>
              <span className={styles.statValue}>{character.stats.street_cred}</span>
            </div>
            <div className={styles.statItem}>
              <span className={styles.statLabel}>Combat</span>
              <span className={styles.statValue}>{character.stats.combat}</span>
            </div>
            <div className={styles.statItem}>
              <span className={styles.statLabel}>Hacking</span>
              <span className={styles.statValue}>{character.stats.hacking}</span>
            </div>
          </div>
        </div>
      </div>
